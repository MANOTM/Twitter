            ...
            <div className="diactivate__setting">
                <Link to={`/profile/${name}`} className="profile__setting hover">
                    <div className="profile__setting__avatar avatar">
                        <img src={defaultProfile} alt="avatar" width="48px" />
                    </div>
                ...
                <div className="Account__option__input">
                    <p className='mini-setting'>You’re about to start the process of deactivating your Wazoo account. Your display name, @username, and public profile will no longer be viewable on Wazoo.com, Wazoo for iOS, or Wazoo for Android.</p>
                </div>
                <div className="Account__option__input">
                    <span className='big-title'>What else you should know</span>
                </div>
                <div className="Account__option__input">
                    <p className='mini-setting'>You can restore your Wazoo account if it was accidentally or wrongfully deactivated for up to 30 days after deactivation.</p>
                </div>
                <div className="Account__option__input">
                ...
                <div className="Account__option__input">
                    <p className='mini-setting'>To use your current @username or email address with a different Wazoo account, <Link to="/settings/account" className='a-link'>change them</Link> before you deactivate this account.</p>
                </div>
                <div className="Account__option__input">
